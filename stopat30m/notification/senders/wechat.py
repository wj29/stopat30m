...
class WechatSender:
    def __init__(self) -> None:
        self._wechat_url = get("notification.wechat_webhook_url") or ""
        self._wechat_max_bytes = get("notification.wechat_max_bytes", default=4000)
        self._wechat_msg_type = get("notification.wechat_msg_type", default="markdown")
