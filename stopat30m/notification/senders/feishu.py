...
from stopat30m.notification.formatters import (
    MIN_MAX_BYTES,
...
class FeishuSender:
    def __init__(self) -> None:
        self._feishu_url = get("notification.feishu_webhook_url") or None
        self._feishu_secret = (get("notification.feishu_webhook_secret") or "").strip()
        self._feishu_keyword = (get("notification.feishu_webhook_keyword") or "").strip()
        self._feishu_max_bytes = get("notification.feishu_max_bytes", default=20000)
        self._webhook_verify_ssl = get("notification.webhook_verify_ssl", default=True)
