...
from stopat30m.notification.formatters import chunk_content_by_max_words


class DiscordSender:
    def __init__(self) -> None:
        self._discord_config = {
            "bot_token": get("notification.discord_bot_token"),
            "channel_id": get("notification.discord_main_channel_id"),
            "webhook_url": get("notification.discord_webhook_url"),
        }
        self._discord_max_words = get("notification.discord_max_words", default=2000)
