...
class AstrbotSender:
    ...
    def __init__(self):
        ...
        self._astrbot_config = {
            'astrbot_url': cfg_get("notification.astrbot_url", default=None) or "",
            'astrbot_token': cfg_get("notification.astrbot_token", default=None) or "",
        }
        self._webhook_verify_ssl = cfg_get("notification.webhook_verify_ssl", default=True)
