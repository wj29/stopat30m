...
class SlackSender:
    def __init__(self) -> None:
        self._slack_webhook_url = get("notification.slack_webhook_url")
        self._slack_bot_token = get("notification.slack_bot_token")
        self._slack_channel_id = get("notification.slack_channel_id")
